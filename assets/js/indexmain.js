    ...
    test_cursor.onsuccess = function(e){
        ...
        if(cursor_result){
            ...
            for(var result in cursor_result.value){
                if(result == 'id'){
                    q+='<span onclick="fetch_for_edit('+cursor_result.value[result]+')" class="edit-products" id="edit_btn" style="display:none;"><i class="fa fa-edit" style="display:none;"></i> Edit</span><span onclick="deleteData('+cursor_result.value[result]+')"class="delete-products" id="delete_btn" style="display:none;"><i class="fa fa-trash" style="display:none;"></i> Delete</span>';
                }
                if(result == 'name'){
    ...
    test_cursor.onsuccess = function(e){
        ...
        if(cursor_result){
            if(cursor_result.value.name.indexOf(query) != -1){
                ...
                for(var result in cursor_result.value){
                        if(result == 'id'){
                            q+='<span onclick="fetch_for_edit('+cursor_result.value[result]+')" class="edit-products" id="edit_btn" style="display:none;"><i class="fa fa-edit" style="display:none;"></i> Edit</span><span onclick="deleteData('+cursor_result.value[result]+')"class="delete-products" id="delete_btn"><i class="fa fa-trash"></i> Delete</span>';
                        }
                        if(result == 'name'){
                            q+='<h4>'+cursor_result.value[result]+'</h4>';
                        }
